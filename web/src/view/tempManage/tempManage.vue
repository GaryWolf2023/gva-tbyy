                ...
                <el-table :data="tableData" style="width: 100%;" height="100%">
                    ...
                    <el-table-column label="操作" fixed="right" width="160" align="center">
                      <template #default>
                          ...
                          <el-button link type="primary" size="small">编辑模板</el-button>
                          <el-button link type="primary" size="small" @click="deletePayloadTempFunc"></el-button>
                      </template>
                    </el-table-column>
                </el-table>
            </div>
        ...
        >
                    ...
                    <el-form :inline="true" :model="payloadTemp" class="demo-form-inline" label-position="left">
                        ...
                        <el-form-item label="模板类型">
                            ...
                            >
                                ...
                                <el-option label="formTemp" value="txt" />
            ...
            <template #footer>
              <span class="dialog-footer">
                ...
                <el-button type="primary" @click="createPayloadTempFunc">
                    创建模板
                </el-button>
              </span>
            </template>
...
import { createPayloadTemp, updatePayloadTemp, deletePayloadTemp, getPayloadTempList, getPayloadTemp } from '@/api/payloadTemp'
...
const createPayloadTempFunc = () => {
    payloadTemp.CreatePerson = "123123"
    createPayloadTemp(payloadTemp).then(res => {
        console.log(res);
        updateDialog.value = false
    })
}
const updatePayloadTempFunc = () => { }
const deletePayloadTempFunc = () => { }
const getPayloadTempListFunc = () => { }
const getPayloadTempFunc = () => {}
</script>
